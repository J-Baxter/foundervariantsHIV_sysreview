...
First run the script 'install_packages.R.' This will ensure that the required packages are installed and loaded to run the analysis. Each script will be able to run, with outputs posted to a 'results' directory and figures to a 'figures' directory. NB: if re-running the analysis, files will be overwritten unless moved to another directory/results directory is renamed eg; ./results-deprecated/.  
...
Postprocessing may be required in order to retrieve the plots generated by binary_poolng_vis.R and binary_metareg_vis.R